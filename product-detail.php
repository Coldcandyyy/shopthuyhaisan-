        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="product-gallery">
                    <img src="uploads/<?php echo $product['hsp_1'] ?: $product['sp_hinh'] ?: 'images/default-product.jpg'; ?>" 
                         class="main-image" id="mainImage" alt="<?php echo $product['sp_ten']; ?>">
                    
                    <div class="thumbnail-images">
                        <?php if($product['hsp_1']): ?>
                        <img src="uploads/<?php echo $product['hsp_1']; ?>" class="thumbnail active" 
                             onclick="changeImage(this, 'uploads/<?php echo $product['hsp_1']; ?>')" alt="Hình 1">
                        <?php endif; ?>
                        
                        <?php if($product['hsp_2']): ?>
                        <img src="uploads/<?php echo $product['hsp_2']; ?>" class="thumbnail" 
                             onclick="changeImage(this, 'uploads/<?php echo $product['hsp_2']; ?>')" alt="Hình 2">
                        <?php endif; ?>
                        
                        <?php if($product['hsp_3']): ?>
                        <img src="uploads/<?php echo $product['hsp_3']; ?>" class="thumbnail" 
                             onclick="changeImage(this, 'uploads/<?php echo $product['hsp_3']; ?>')" alt="Hình 3">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-info">
                    ...
                    <div class="quantity-selector">
                        ...
                        <button class="btn-quantity" id="btn-minus">-</button>
                        <input type="number" class="quantity-input" id="quantity" value="1" min="1">
                        <button class="btn-quantity" id="btn-plus">+</button>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card related-product-card">
                        <img src="uploads/<?php echo $related['hsp_1'] ?: $related['sp_hinh'] ?: 'images/default-product.jpg'; ?>" 
