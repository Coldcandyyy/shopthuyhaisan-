...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand" href="index.php">TÂM AN </a>
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="products.php?gender=nam">CÁ TẦM</a></li>
                        <li><a class="dropdown-item" href="products.php?gender=nu">MỰC NANG</a></li>
                        <li><a class="dropdown-item" href="products.php?sale=1">TẤT CẢ</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="discover.php">KHÁM PHÁ</a>
                </li>
                <li class="nav-item">
